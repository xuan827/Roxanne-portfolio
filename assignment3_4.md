...
- I choose hierarchy graph because there is a disassembly of factors, the hierarchy diagram can better show the corresponding relationship than using two subgraphs with pointer. And audience can click the explained area to observe the further disassembly of factors.
